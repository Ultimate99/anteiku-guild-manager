...
- Milestone 30G-G: TCG balance direction reset and Epic-rate candidate simulation completed.
- Milestone 30G-H: TCG Candidate A Epic-rate balance patch implemented, locally validated, and production-applied.
- Milestone 30G-I0: Owner-only TCG test-state reset implemented, locally validated, and production-applied.
