...
- Economy, wallets, duplicate burning/crafting, shop, and premium currency.
- Duplicate Burn/Craft is experimental/later and not required for default member release.
- Trading is the preferred future duplicate/social direction, pending a separate design/spec.
...
- 30G-A: TCG economy/drop balance planning around the Current Low-Rate Baseline. Complete.
- 30G-B: Balance Simulation for Current Low-Rate Baseline. Complete.
- 30G-C: Duplicate sell/burn/pity simulation before any drop-rate patch. Complete.
- 30G-D: Duplicate Economy Design Specification for balanced dust/crafting plus soft pity guardrails. Complete.
- 30G-E: Duplicate economy backend/RPC/RLS implementation planning. Complete.
- 30G-F1: Anteiku Fragments / duplicate burn / duplicate summary / missing-card crafting backend. Complete and production-applied.
- 30G-F2: Backend-only Soft Pity counters and pack-opening integration. Complete and production-applied.
- 30G-F3: Owner-only fragment/burn/craft/pity UI preview. Complete pending Owner manual mutation smoke.
- 30G-G: Balance Direction Reset + Epic Rate Simulation. Complete as docs/local simulation only.
- 30G-H: Candidate A Epic-rate balance patch. Complete and production-applied.
- 30G-I0: Owner-only TCG Test State Reset. Complete and production-applied; Owner manual reset smoke remains optional and must not be performed by Codex.
- 30F-N: Member-facing free shop/economy planning after Owner Balance review, pack-inventory review, and 30G balance simulation.
- 30G: Admin TCG tools.
