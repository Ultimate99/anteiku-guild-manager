...
- 30F-H: Owner-only TCG analytics UI in the existing `/tcg` Owner area.
- 30F-I: Member-facing free shop/economy planning after Owner analytics and pack-inventory review.
- 30G: Admin TCG tools.
