...
- All approved production migrations through `20260531001100_active_profile_cp_analytics_audit_admin.sql` are applied remotely, including `20260523000100_member_roster_status_system.sql`, CP Update Window / CP Ranking / Rank Badge migrations, cosmetics migrations, Admin Analytics / Live CP Growth migrations, `20260528000100_three_v_three_team_finder.sql`, Guild Wall / Global Wall / Ghoul Rep / Public Profile / Push migrations, `20260531000100_account_switcher_foundation.sql`, and active-profile migrations through Profile/Cosmetics, Wall/Profile Reactions, 3v3, Push, Own CP, GvG voting, audit actor alignment, Active Admin Context, Non-CP Admin, and CP Admin / Analytics / Audit Logs.
...
- Account Switcher active-profile migration is complete for the planned 29B-29F scope. Final regression passed after i18n-only commit `eaf16b5 fix: update account switcher rollout copy`; Home, Profile Settings / Account Switcher, Ranking, GvG, 3v3, Wall, AdminPanel, Admin CP, CP Ranking, Analytics, Audit Logs, Members, Permissions, and Tools loaded read-only in production with no CP/privacy regression.
